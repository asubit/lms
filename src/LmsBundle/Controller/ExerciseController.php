...
use LmsBundle\Entity\Exercise;
use LmsBundle\Form\ExerciseType;
...
class ExerciseController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $exercises = $em->getRepository('LmsBundle:Exercise')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('LmsBundle\Form\ExerciseType', $exercise);
    ...
    {
        $deleteForm = $this->createDeleteForm($exercise);
        $editForm = $this->createForm('LmsBundle\Form\ExerciseType', $exercise);
